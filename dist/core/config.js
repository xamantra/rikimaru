...
class Config {
    ...
    static get COMMAND_PREFIX() {
        return (process.env.COMMAND_PREFIX || require("../extras/env").COMMAND_PREFIX);
    }
    static get MYSQL_HOST() {
        return process.env.MYSQL_HOST || require("../extras/env").MYSQL_HOST;
    }
    static get MYSQL_PORT() {
        return (Number(process.env.MYSQL_PORT) || require("../extras/env").MYSQL_PORT);
    }
    static get MYSQL_USERNAME() {
        return (process.env.MYSQL_USERNAME || require("../extras/env").MYSQL_USERNAME);
    }
    static get MYSQL_PASSWORD() {
        return (process.env.MYSQL_PASSWORD || require("../extras/env").MYSQL_PASSWORD);
    }
    static get MYSQL_DATABASE() {
        return (process.env.MYSQL_DATABASE || require("../extras/env").MYSQL_DATABASE);
    }
