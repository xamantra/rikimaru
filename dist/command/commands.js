...
exports.help = new bot_command_1.BotCommand("help", "Show all my command list.", false, false, enums_1.Response.ChannelReply, 5, functions_1.helpFunction);
exports.dmhelp = new bot_command_1.BotCommand("dmhelp", "Just similar with the* ***-help*** *command.", false, false, enums_1.Response.DirectMessage, 5, functions_1.helpFunction);
