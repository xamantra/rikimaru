...
class MalBindFunction {
    ...
    async CheckProfile(message, command, dm, code, about) {
        ...
        if (about === null) {
            message.channel.send(`:regional_indicator_x: Ge me nasai! I wasn't able to find mal user: **${command.Parameter}**`);
            return;
        }
        else {
