...
class CommandManager {
    ...
    Init() {
        ...
        const mediaExample = new media_command_example_1.MediaExample(5);
        ...
        const when = new bot_command_1.BotCommand("when", `Search for a schedule of an anime that matches the keyword/parameter.\nYou can either put the exact anime title or just a keyword.`, true, enums_1.Response.ChannelReply, whenAnimeFunction, mediaExample);
        const dmwhen = new bot_command_1.BotCommand("dmwhen", "Just similar with the* ***-when*** *command.", true, enums_1.Response.DirectMessage, whenAnimeFunction, mediaExample);
        const whenmanga = new bot_command_1.BotCommand("whenmanga", `Search for a schedule of a manga that matches the keyword/parameter.\nYou can either put the exact manga title or just a keyword.`, true, enums_1.Response.ChannelReply, whenMangaFunction, mediaExample);
        const dmwhenmanga = new bot_command_1.BotCommand("dmwhenmanga", `Just similar with the* ***-whenmanga*** *command.`, true, enums_1.Response.DirectMessage, whenMangaFunction, mediaExample);
